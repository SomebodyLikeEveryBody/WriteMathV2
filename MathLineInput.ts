...
declare var $: any;
declare var AutoCompleter: any;
declare var g_keywordsList: any;
...
class MathLineInput {
    ...
    public constructor() {
        ...
        this._mathField = MathQuill.getInterface(2).MathField(this.jQEl[0], {
            handlers: {
                edit: () => {
                },
    
                enter: () => {
                    if ((this._autoCompleter.AutoCompleterManager.autoCompletionWidget.isVisible === false)) {
                ...
                upOutOf: () => {
                    if (this.hasPreviousMathLineInput() && (this._autoCompleter.AutoCompleterManager.autoCompletionWidget.isVisible === false)) {
                        this.previousMathLineInput.focus();
                    }
                },

                downOutOf: () => {
                    if (this.hasNextMathLineInput() && (this._autoCompleter.AutoCompleterManager.autoCompletionWidget.isVisible === false)) {
